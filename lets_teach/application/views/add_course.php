...
<head>
	<title>Add Course - Let's Teach</title> 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="intro-text ">
						<h1>Add Course</h1>
						<p><span><a href="<?=site_url('/Home');?>">Home </a><i class='fa fa-angle-right'></i></span> <span><a href="<?=site_url('/Course');?>">Course </a><i class='fa fa-angle-right'></i></span> <span>Add Course</span></p>
					</div>
				</div>
			</div><!-- /.row -->
		</div><!-- /.container -->
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Course Title" name="institle" id="institle">
                                </div>
                                <font style="color: #E74C3C;"><?=form_error('institle','<div class="error">','</div>');?></font>
                            </div>
                            <div class="col-sm-12">
                            	<div class="form-group">
                                    <input class="form-control" type="file" name="insimg" id="insimg">
                                </div>
                                <font style="color: #E74C3C;"><?=form_error('insimg','<div class="error">','</div>');?></font>
                            </div>	
                            <div class="col-sm-12">
                            	<div class="form-group">
